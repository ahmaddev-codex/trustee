// Full-page transition screen for moments with a real wait on another
// system (Monnify checkout hand-off, auth) — not for ordinary route loads,
// which already get content-shaped skeletons via loading.tsx.
